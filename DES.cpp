...
{
	string pt, key;
	cout<<"Enter plain text (in hexadecimal format): ";
	cin>>pt;
	cout<<"Enter key (in hexadecimal format): ";
	cin>>key;
...
/*SAMPLE OUTPUT
Enter plain text (in hexadecimal format): 02468aceeca86420
Enter key (in hexadecimal format): 0f1571c947d9e859

Encryption:

After initial permutation: 5A005A003CF03C0F
After splitting: L0=5A005A00 R0=3CF03C0F
...
After splitting: L0=25896490 R0=75E8FD8F
